 ...
 * @author Dave
 */
@WebServlet(name = "ListarPersonaServlet", urlPatterns = {"/persona/listar"})
public class ListarPersonaServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<PersonaVO> list = manager.listar();
        RequestDispatcher rd = getServletContext().getRequestDispatcher("/persona/listar.jsp");
